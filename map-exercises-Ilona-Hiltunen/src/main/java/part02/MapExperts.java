...
public class MapExperts {
    ...
    public Map<Character, Integer> countLetters(String word) {
        ...
        Character kirjain = word.charAt(i);
        mappi.merge(kirjain, 1, Integer::sum);
        }
    ...
    public Map<Integer, String> reverseMap(Map<String, Integer> map) {
         ...
         */
        Map<Integer, String> vaihettu = new HashMap<>();
        
        for (Map.Entry<String, Integer> entry : map.entrySet()) {
        vaihettu.put(entry.getValue(), entry.getKey());
        }
    ...
    public Map<String, Course> createMapFromList(List<Course> list) {
        ...
        Course kurssi = list.get(i);
        kurssit.put(kurssi.code(), kurssi);
        }
